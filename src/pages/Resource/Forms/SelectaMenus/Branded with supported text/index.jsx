...
export default function BrandedWithSupportedText() {
        ...
        <>
          ...
          <div className="relative">
            ...
            <div className="inline-flex items-center gap-x-1.5 rounded-l-md bg-indigo-600 px-3 py-2 text-white shadow-sm">
             ...
             <Listbox.Button className="inline-flex items-center rounded-l-none rounded-r-md bg-red-600 appearance-none p-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 focus:ring-offset-gray-50">
