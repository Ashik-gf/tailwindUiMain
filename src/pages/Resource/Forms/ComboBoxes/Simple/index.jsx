...
const people = [
  ...
  { id: 2, name: 'Ashik Alexander' },
  { id: 3, name: 'Virat Alexander' },
  { id: 4, name: 'Alixa Alexander' },
  { id: 5, name: 'Monalisha Alexander' },
  { id: 6, name: 'lㅠㄴㄱㄷ Alexander' },
  { id: 7, name: 'Sonia Alexander' },
  // More users...
]
