...
export default function With_large_size_selector() {
  ...
  return (
    <div className="div relative">
      <div
        class={` ${
          open
            ? " absolute h-screen inset-0 hidden bg-gray-500 bg-opacity-75 transition-opacity md:block"
            : " hidden"
        } "`}
      ></div>
            ...
            <div className="sm:col-span-8 lg:col-span-7">
              ...
              <section aria-labelledby="options-heading" className="mt-6">
                ...
                <form>
                  ...
                  <div className="mt-6 bg-indigo-600 rounded-xl">
                    <button
                      type="submit"
