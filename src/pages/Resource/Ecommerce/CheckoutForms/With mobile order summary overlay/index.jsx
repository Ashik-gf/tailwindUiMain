...
export default function With_mobile_order_summary_overlay() {
  return (
    <div className="bg-white">
      {/* Background color split screen for large screens */}
      <div className=" left-0 top-0 hidden h-full w-1/2 bg-white lg:block" aria-hidden="true" />
      <div className=" right-0 top-0 hidden h-full w-1/2 bg-gray-50 lg:block" aria-hidden="true" />
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 xl:gap-x-48">
        ...
        >
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <Popover className=" inset-x-0 bottom-0 flex flex-col-reverse text-sm font-medium text-gray-900 lg:hidden">
