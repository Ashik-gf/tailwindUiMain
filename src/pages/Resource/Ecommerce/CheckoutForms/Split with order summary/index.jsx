...
export default function Split_with_order_summary() {
  return (
    <div className="bg-white">
      {/* Background color split screen for large screens */}
      <div
        className=" left-0 top-0 hidden h-full w-1/2 bg-white lg:block"
        aria-hidden="true"
      />
      <div
        className="right-0 top-0 hidden h-full w-1/2 bg-red-900 lg:block"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
        ...
        <div className="bg-indigo-900">
          <section
            ...
            className=" bg-blue-600 py-12 text-indigo-300 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:w-full lg:max-w-lg lg:bg-transparent lg:px-0 lg:pb-24 lg:pt-0"
          >
