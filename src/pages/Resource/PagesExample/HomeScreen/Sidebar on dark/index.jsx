...
export default function SidebarOnDark() {
    ...
    <>
      ...
      */}
      <div>
        ...
        {/* Static sidebar for desktop xl:fixed */}
       <div className=" block md:flex bg-gray-800">
       <div className="hidden bg-gray-800  xl:inset-y-0 xl:z-50 xl:flex xl:w-72 xl:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
        ...
        <div className=" w-full">
          ...
          <div className=" top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-white/5 bg-gray-900 px-4 shadow-sm sm:px-6 lg:px-8">
        ...
        {/* aside active */}
         {/* Activity feed */}
         <aside className="bg-gray-800 lg:bottom-0 lg:right-8 lg:top-8 lg:w-96 lg:overflow-y-auto lg:border-l lg:border-white/5">
            <header className="flex items-center justify-between border-b border-white/5 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
