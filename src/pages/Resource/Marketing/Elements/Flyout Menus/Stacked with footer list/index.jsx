...
export default function Stacked_with_footer_list() {
  return (
    <Popover className="relative w-full flex flex-row justify-center">
      <Popover.Button className="inline-flex p-2 mt-3 items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
        <span>Resources</span>
      ...
      >
        <Popover.Panel className=" absolute left-1/2 top-4 z-10 mt-5 flex w-screen max-w-max -translate-x-1/2 px-4">
