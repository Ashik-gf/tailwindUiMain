...
export default function Simple_with_descriptions() {
  return (
    <Popover className="relative w-full flex flex-row justify-center">
      <Popover.Button className="inline-flex mt-4 p-2 items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
        <span>Solutions</span>
      ...
      >
        <Popover.Panel className="absolute top-12 left-1/2 z-10 mt-5 flex w-screen max-w-max -translate-x-1/2 px-4">
