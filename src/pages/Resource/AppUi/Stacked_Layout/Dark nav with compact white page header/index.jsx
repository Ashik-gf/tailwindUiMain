...
export default function Darknavwithcompactwhitepageheader() {
  return (
    <>
      {/*
      ...
      */}
      <div className="min-h-full">
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 h-[50vh] border-2 border-gray-200 bg-gray-300">{/* Your content */}</div>
        </main>
      </div>
    </>
  )
