...
export default function BrandNavWithOverlap() {
  return (
    <>
      {/*
      ...
      */}
      <div className="min-h-full">
        ...
        <main className="-mt-32">
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8 h-[50vh] w-[98%] rounded-lg bg-gray-200">{/* Your content */}</div>
        </main>
      </div>
    </>
  )
