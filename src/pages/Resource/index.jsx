...
<div className="w-full mt-8 flex justify-center mx-12 ">
<div className=" mx-8">
<svg className=" h-8  flex justify-center mx-8 text-slate-900">
...
<p className=" mt-5 text-start text-sm leading-6 text-slate-500">
